...
import groupMeeting from "@/assets/group-meeting.jpg";
  ...
  return (
    <section className="pt-24 md:pt-28 pb-14 md:pb-20 px-4 sm:px-6">
      <div className="container mx-auto text-center max-w-4xl">
        ...
        >
          The one-link scheduler where everyone paints their availability.
          No back-and-forth — just share, paint, and meet.
        </motion.p>
        ...
        >
          <Button size="lg" className="rounded-full px-8 py-6 text-base font-semibold shadow-lg shadow-primary/20">
        ...
        >
          ...
          <img
            ...
            className="relative rounded-2xl shadow-2xl shadow-foreground/10 w-full object-cover aspect-[16/10]"
          />
        </motion.div>
      </div>
    </section>
