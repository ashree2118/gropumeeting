...
const problems = [
  {
    ...
    description:
      "Endless group chats trying to find one time that fits. By the time you agree, the week is over.",
  ...
  },
  {
    ...
    description:
      "Half your group is in another timezone. Manually converting hours leads to missed meetings and frustration.",
  ...
  },
  {
    ...
    description:
      "Polls, spreadsheets, reply-all threads — the more people involved, the messier it gets.",
    ...
    <section id="features" className="py-14 md:py-20 px-4 sm:px-6">
      <div className="container mx-auto max-w-5xl">
        <ScrollFadeIn className="text-center mb-14">
          <span className="inline-block text-sm font-semibold text-card-on uppercase tracking-wider bg-card-pink px-4 py-1.5 rounded-full mb-4">
            The Problem
          </span>
